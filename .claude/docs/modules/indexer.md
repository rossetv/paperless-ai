...
**Entrypoint:** `src/indexer/daemon/_boot.py::main`, re-exported as `indexer.daemon:main` and wired to the console script `paperless-indexer-daemon` (`pyproject.toml:25`).
...
- Specs: `docs/superpowers/specs/2026-05-20-paperless-semantic-search-design.md` (the "SPEC §" references throughout the code); `docs/superpowers/specs/2026-05-22-web-redesign-design.md` (the hot-reload, rebuild sentinel, and dashboard activity work)
